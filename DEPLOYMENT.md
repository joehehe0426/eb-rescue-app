...
This guide will help you deploy the EB Tire Repair App to Cloudflare Pages.
...
6. Select your repository (`eb-tire-app`)

### 3. Configure Build Settings

Cloudflare Pages will auto-detect Vite, but verify these settings:

- **Project name**: `eb-tire-app` (or your preferred name)
